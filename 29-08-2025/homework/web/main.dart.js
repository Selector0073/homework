...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t3, t4, t1 = {},
        ...
        labyrinth = A._setArrayType([A._setArrayType(["#", "#", "#", "#", "#", "#", "#"], t2), A._setArrayType(["#", " ", " ", " ", "#", "F", "#"], t2), A._setArrayType(["#", " ", "#", " ", "#", " ", "#"], t2), A._setArrayType(["#", "P", "#", " ", " ", " ", "#"], t2), A._setArrayType(["#", "#", "#", "#", "#", "#", "#"], t2)], type$.JSArray_List_String);
      t2 = document;
      t3 = t2.querySelector("#maze");
      t3.toString;
      t2 = t2.querySelector("#message");
      t2.toString;
      t1.playerX = 1;
      t1.playerY = 3;
      t3 = new A.main_renderMaze(t3, labyrinth);
      t3.call$0();
      t4 = window;
      t4.toString;
      A._EventStreamSubscription$(t4, "keydown", type$.nullable_void_Function_KeyboardEvent._as(new A.main_closure(t1, labyrinth, t3, t2)), false, type$.KeyboardEvent);
    },
    main_renderMaze: function main_renderMaze(t0, t1) {
      this.mazeElement = t0;
      this.labyrinth = t1;
    },
  ...
  A.main_renderMaze.prototype = {
    call$0() {
      var t3, _i, t4, t5, div, list,
        t1 = this.mazeElement,
        t2 = J.getInterceptor$x(t1);
      t2.get$children(t1).clear$0(0);
      for (t3 = this.labyrinth, _i = 0; _i < 5; ++_i)
        for (t4 = B.JSArray_methods.get$iterator(t3[_i]); t4.moveNext$0();) {
          t5 = t4.get$current();
          ...
          switch (t5) {
            case "#":
              list = div.classList;
              list.contains("wall").toString;
              list.add("wall");
              break;
            case "P":
              list = div.classList;
              list.contains("player").toString;
              list.add("player");
              break;
            case "F":
              list = div.classList;
              list.contains("finish").toString;
              list.add("finish");
              break;
            default:
              list = div.classList;
          ...
          t2.get$children(t1).add$1(0, div);
        }
    },
    $signature: 0
  };
  A.main_closure.prototype = {
    call$1($event) {
      ...
      t2 = _this.labyrinth;
      if (!(newY0 >= 0 && newY0 < 5))
        return A.ioore(t2, newY0);
      t3 = t2[newY0];
      if (!(newX0 >= 0 && newX0 < t3.length))
        return A.ioore(t3, newX0);
      targetCell = t3[newX0];
      if (targetCell !== "#") {
        if (!(newY >= 0 && newY < 5))
          return A.ioore(t2, newY);
        B.JSArray_methods.$indexSet(t2[newY], newX, " ");
        B.JSArray_methods.$indexSet(t2[newY0], newX0, "P");
        t1.playerX = newX0;
        t1.playerY = newY0;
        _this.renderMaze.call$0();
        if (targetCell === "F")
          J.set$text$x(_this.messageElement, "\u0412\u0438 \u0432\u0438\u0433\u0440\u0430\u043b\u0438!");
      }
    },
    $signature: 12
  };
  ...
  (function inheritance() {
    ...
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, J.JSArray, A.EventTarget, A.DomException, A.DomTokenList, A.Event, A._HtmlCollection_JavaScriptObject_ListMixin, A._NodeList_JavaScriptObject_ListMixin]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(~())", "Null(@)", "Null()", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(Object,StackTrace)", "~(Event)", "bool(Node)", "Element(Node)", "~(KeyboardEvent)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","AElement":"SvgElement","GraphicsElement":"SvgElement","AudioElement":"HtmlElement","MediaElement":"HtmlElement","HtmlDocument":"Node","Document":"Node","CompositionEvent":"UIEvent","CDataSection":"CharacterData","Text":"CharacterData","DomError":"JavaScriptObject","MathMLElement":"Element","HtmlFormControlsCollection":"HtmlCollection","JSBool":{"bool":[],"TrustedGetRuntimeType":[]},"JSNull":{"TrustedGetRuntimeType":[]},"JavaScriptObject":{"JSObject":[]},"LegacyJavaScriptObject":{"JSObject":[]},"JSArray":{"List":["1"],"JSObject":[],"Iterable":["1"]},"JSArraySafeToStringHook":{"SafeToStringHook":[]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"JSObject":[],"Iterable":["1"]},"ArrayIterator":{"Iterator":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[],"TrustedGetRuntimeType":[]},"JSNumNotInt":{"num":[],"TrustedGetRuntimeType":[]},"JSString":{"String":[],"TrustedGetRuntimeType":[]},"LateError":{"Error":[]},"ListIterator":{"Iterator":["1"]},"MappedIterable":{"Iterable":["2"]},"MappedIterator":{"Iterator":["2"]},"WhereIterable":{"Iterable":["1"]},"WhereIterator":{"Iterator":["1"]},"NullError":{"TypeError":[],"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"Closure0Args":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"RuntimeError":{"Error":[]},"_Error":{"Error":[]},"_TypeError":{"TypeError":[],"Error":[]},"AsyncError":{"Error":[]},"_Future":{"Future":["1"]},"_Zone":{"Zone":[]},"_RootZone":{"_Zone":[],"Zone":[]},"ListBase":{"List":["1"],"Iterable":["1"]},"int":{"num":[]},"List":{"Iterable":["1"]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"StackOverflowError":{"Error":[]},"_StringStackTrace":{"StackTrace":[]},"Element":{"Node":[],"EventTarget":[],"JSObject":[]},"Event":{"JSObject":[]},"KeyboardEvent":{"Event":[],"JSObject":[]},"Node":{"EventTarget":[],"JSObject":[]},"HtmlElement":{"Element":[],"Node":[],"EventTarget":[],"JSObject":[]},"AnchorElement":{"Element":[],"Node":[],"EventTarget":[],"JSObject":[]},"AreaElement":{"Element":[],"Node":[],"EventTarget":[],"JSObject":[]},"CharacterData":{"Node":[],"EventTarget":[],"JSObject":[]},"DomException":{"JSObject":[]},"DomTokenList":{"JSObject":[]},"_ChildrenElementList":{"ListBase":["Element"],"List":["Element"],"Iterable":["Element"],"ListBase.E":"Element"},"EventTarget":{"JSObject":[]},"FormElement":{"Element":[],"Node":[],"EventTarget":[],"JSObject":[]},"HtmlCollection":{"ListBase":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"JSObject":[],"Iterable":["Node"],"ListBase.E":"Node","ImmutableListMixin.E":"Node"},"_ChildNodeListLazy":{"ListBase":["Node"],"List":["Node"],"Iterable":["Node"],"ListBase.E":"Node"},"NodeList":{"ListBase":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"JSObject":[],"Iterable":["Node"],"ListBase.E":"Node","ImmutableListMixin.E":"Node"},"SelectElement":{"Element":[],"Node":[],"EventTarget":[],"JSObject":[]},"UIEvent":{"Event":[],"JSObject":[]},"Window":{"EventTarget":[],"JSObject":[]},"_EventStream":{"Stream":["1"]},"FixedSizeListIterator":{"Iterator":["1"]},"FilteredElementList":{"ListBase":["Element"],"List":["Element"],"Iterable":["Element"],"ListBase.E":"Element"},"SvgElement":{"Element":[],"Node":[],"EventTarget":[],"JSObject":[]}}'));
  var string$ = {
